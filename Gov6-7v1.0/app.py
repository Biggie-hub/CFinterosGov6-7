...
yellow_db = ["Bolivia", "Brazil", "Brunei", "Cote d'Ivoire", "Egypt", "Ghana", "Guatemala", "India", "Indonesia",
             "Japan", "Jordan", "Kenya", "Kuwait", "Morocco", "Nicaragua", "Norway", "Pakistan", "Paraguay", "Qatar",
...
countries = {
    ...
    "Bahrain": "The company does business in Bahrain. Bahrain maintains few barriers to trade in goods and services "
    ...
    "Cote d'Ivoire": "The company does business in Cote d'Ivoire. Cote d'Ivoire imposes barriers to trade including "
                     "a lack of regulatory transparency and bans on the import of certain goods.",
    "Dominican Republic": "The company does business in the Dominican Republic. The Dominican Republic maintains few "
                          ...
                          "investment.",
    "Ecuador": "The company does business in Ecuador. Ecuador maintains few barriers to trade in goods and services "
               "and few restrictions on foreign capital flows and investment.",
    "Egypt": "The company does business in Egypt. Egypt imposes barriers to trade including costly and delayed customs "
             "processing, restrictions on foreign equity in certain sectors, and a mandate that 60% of senior "
             "executives be Egyptian citizens at information technology (IT) companies.",
    "El Salvador": "The company does business in El Salvador. El Salvador maintains few barriers to trade in goods and "
                  "services and few restrictions on foreign capital flows and investment.",
    "Ethiopia": "The company does business in Ethiopia. Ethiopia maintains barriers to trade including a complex "
                "import licensing regime, strict foreign exchange controls, and monopoly control over various sectors "
    ...
    "Austria": "The company does business in Austria, which is a member of the European Union (EU). The EU "
               "imposes barriers to trade including data localization requirements that hinder cross-border trade and "
    ...
    "Pakistan": "The company does business in Pakistan. Pakistan imposes barriers to digital trade including data "
                "localization laws, in addition to periodical blocking to Internet-based services deemed blasphemous "
                "or immoral by the federal government.",
    "Panama": "The company does business in Panama. Panama maintains few barriers to trade in goods and services and "
              "few restrictions on foreign capital flows and investment.",
    "Paraguay": "The company does business in Paraguay. Paraguay maintains investment barriers to foreign companies "
                "which requires companies to demonstrate 'just cause' to terminate, modify, or decide not to renew "
                "contracts with Paraguayan distributors.",
    ...
    "Qatar": "The company does business in Qatar. Qatar maintains various barriers to trade including a required "
             "import license for the importation of most products, limitations on foreign equity participation, and "
             "the requirement of a license to provide Voice over Internet Protocol (VoIP) services, granting such "
             "licenses only to companies intending to charter in Qatar.",
    "Russia": "The company does business in Russia. The United States and Russia currently maintain sanctions "
              ...
              "import substitution policies, data localization laws, and favorable market conditions for state-owned "
              "enterprises.",
    ...
    "South Africa": "The company does business in South Africa. South Africa maintains few barriers to trade in goods "
                    "and services and few restrictions on foreign capital flows and investment.",
    ...
    "Switzerland": "The company does business in Switzerland. Switzerland maintains barriers to trade in regards to "
                   "digital trade and electronic commerce which limits to the cross-border transfer of personal data "
                   "of Swiss subjects.",
    ...
    "The Philippines": "The company does business in the Philippines. The Philippines maintains barriers to digital "
                       "trade which requires cloud computing providers to partner with a 60% Philippine owned company "
                       "in order to participate in a government contract.",
    ...
    "Turkey": "The company does business in Turkey. Turkey imposes barriers to trade including import restrictions, "
              "government procurement restrictions, data localization laws, imposed regulation on the use of "
              "encryption on hardware and software systems, and various investment barriers.",
